...
const CompanyOffcanvas = forwardRef(({ Title, handleSubmit, editData, setEditData }, ref) => {
                        ...
                        <form onClick={(e) => handleSubmit(e)}>
                            ...
                            <div className="col-xl-6 mb-3">
                                ...
                                <div className="col-xl-6 mb-3">
                                    ...
                                    <input type="text" className="form-control" name="title" defaultValue={editData.title} onChange={handleChange} id="exampleFormControlInput1" placeholder="" />
                                </div>
                               
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput3" className="form-label">User Name <span className="text-danger">*</span></label>
                                    <input type="email" className="form-control" name="email" defaultValue={editData.email} onChange={handleChange} id="exampleFormControlInput3" placeholder="" />
                                </div>
                                <div className="col-xl-6 mb-3">
