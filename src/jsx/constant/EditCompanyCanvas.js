...
// const EditCompanyOffcanvas = forwardRef((props, ref) => {
//     const {formData, tableData, setTableData,headers} = props;
...
//             item.emplid === editedData.emplid ? { ...item, ...editedData } : item
//           );
...
//                                     <input type="text" className="form-control" id="exampleFormControlInput2" placeholder="" name="emplid" value={editedData?.emplid} onChange={handleInputChange} />
//                                 </div> */}
//                                 <div className="col-xl-6 mb-3">
//                                     <label htmlFor="exampleFormControlInput1" className="form-label">{headers.Second}<span className="text-danger">*</span></label>
//                                     <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="" name="title" value={editedData?.title} onChange={handleInputChange}/>
//                                 </div>
                               
//                                 <div className="col-xl-6 mb-3">
//                                     <label htmlFor="exampleFormControlInput3" className="form-label">{headers.Fourth}<span className="text-danger">*</span></label>
//                                     <input type="email" name="email" value={editedData?.email} className="form-control" id="exampleFormControlInput3" placeholder="" onChange={handleInputChange} />
//                                 </div>
//                                 <div className="col-xl-6 mb-3">
...
//                                 </div>
//                                 <div className="col-xl-6 mb-3">
//                                     <label htmlFor="exampleFormControlInput3" className="form-label">{headers.Third}<span className="text-danger">*</span></label>
//                                     <input type="text" className="form-control" id="exampleFormControlInput2" placeholder="" name="department" value={editedData?.department} onChange={handleInputChange}/>
//                                 </div>
//                                 <div className="col-xl-6 mb-3">
//                                     <label className="form-label">{headers.Six}<span className="text-danger">*</span></label>
//                                     <input type="text" className="form-control" id="exampleFormControlInput88" placeholder="" name="usergroup" value={editedData?.usergroup} onChange={handleInputChange}/>
//                                 </div>
//                                 <div className="col-xl-6 mb-3">
//                                     <label htmlFor="exampleFormControlInput88" className="form-label">{headers.Five}<span className="text-danger">*</span></label>
//                                     <input type="text" className="form-control" id="exampleFormControlInput88" placeholder="" name="contact" value={editedData?.contact} onChange={handleInputChange}/>
//                                 </div>
//                                 <div className="col-xl-6 mb-3">
//                                     <label htmlFor="exampleFormControlInput88" className="form-label">{headers.Seven}<span className="text-danger">*</span></label>
//                                     <input type="text" className="form-control" id="exampleFormControlInput88" placeholder="" name="location" value={editedData?.location} onChange={handleInputChange}/>
//                                 </div>
//                                 {/* <div className="col-xl-6 mb-3">
...
// export default EditCompanyOffcanvas;
