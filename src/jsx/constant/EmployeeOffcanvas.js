                    ...
                    <div className="container-fluid">
                        ...
                        <form onClick={(e) => handleSubmit(e)}>
                            <div className="row">
                                ...
                                <input type="text" name="title" defaultValue={editData.title} onChange={handleChange} className="form-control" id="exampleFormControlInput2" placeholder="" />
                                </div>
                                <div className="col-xl-6 mb-3">
                                ...
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput5" name="age" defaultValue={editData.age} onChange={(e)=>handleChange} className="form-label">Age [Year(s)] <span className="text-danger">*</span></label>
                                ...
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput11" className="form-label">City <span className="text-danger">*</span></label>
                                ...
                                <div className="col-xl-6 mb-3" >
                                    ...
                                    <div style={{ background: "white" }} ><StateSelect
                                        countryid={countryid}
                                        onChange={(e) => {
                                            setstateid(e.id);
                                        }}
                                ...
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput12" className="form-label">Pincode<span className="text-danger">*</span></label>
                                    <input type="number" className="form-control" id="exampleFormControlInput12" placeholder="" />
                                </div>
                                <div className="col-xl-6 mb-3">
                                    ...
                                    <input type="number" name="drivinfExperience" defaultValue={editData.drivinfExperience} onChange={(e)=>handleChange} className="form-control" id="exampleFormControlInput6" placeholder="" />
                                </div>
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput88" className="form-label">Mobile <span className="text-danger">*</span></label>
                                    <input type="number" name="contact" defaultValue={editData.contact} onChange={(e)=>handleChange} className="form-control" id="exampleFormControlInput88" placeholder="" />
                                </div>
                                <div className="col-xl-6 mb-3">
                                ...
                                <div className="col-xl-6 mb-3">
                                    <label className="form-label">Tag via<span className="text-danger">*</span></label>
                                    <select className="default-select form-control">
                                        <option data-display="Select">Please select</option>
                                ...
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput7" className="form-label">RFID / Beacon Tag <span className="text-danger">*</span></label>
                                    <input type="text" className="form-control" id="exampleFormControlInput7" placeholder="" />
                                </div>
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput9" className="form-label">License to Drive <span className="text-danger">*</span></label>
