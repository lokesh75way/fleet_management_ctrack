...
const VehicleOffCanvas = forwardRef(
                ...
                <div className="row">
                  <div className="col-xl-6 mb-3">
                    ...
                    <input
                      ...
                      name="vehicleName"
                      defaultValue={editData.vehicleName}
                  ...
                  <div className="col-xl-6 mb-3">
                    ...
                    <input
                      ...
                      className="form-control"
                      name="IMEINumber"
                      defaultValue={editData.IMEINumber}
                      onChange={handleChange}
                  ...
                  <div className="col-xl-6 mb-3">
                    ...
                    <input
                      ...
                      className="form-control"
                      name="simNumber"
                      defaultValue={editData.simNumber}
                      onChange={handleChange}
                  ...
                  <div className="col-xl-6 mb-3">
                    <label
                      ...
                      className="form-label"
                    >
                      GPS Device Type <span className="text-danger">*</span>
                    </label>
                    <input
                      type="text"
                      className="form-control"
                      name="GPSDeviceType"
                      defaultValue={editData.GPSDeviceType}
                      onChange={handleChange}
                  ...
                  <div className="col-xl-6 mb-3">
                    ...
                    <input
                      ...
                      defaultValue={editData.distanceCounter}
                      onChange={handleChange}
                  ...
                  <div className="col-xl-6 mb-3">
                    ...
                    <input
                      ...
                      className="form-control"
                      name="speedDetection"
                      defaultValue={editData.speedDetection}
                      onChange={handleChange}
