              ...
              <div className="row">
                <div className="col-xl-12">
                  ...
                  <div className="text-center mt-4 mb-4">
                    <Link to={"/p2p"} className="btn btn-warning mx-auto">
                      EXCHANGE NOW
                    </Link>
                  </div>
                </div>
                  ...
                  <div className="card-body py-0 pt-4">
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <span
                          className={`fs-16 font-w500  ps-2 ${i === 1 ? "text-danger" : "text-success"}`}
                        >
                          <i
                            className={`bi pe-2 bi-caret-${item.icon}-fill`}
                          ></i>
                        </span>
                      </div>
                    </div>
              ...
              <div className="card">
                ...
                <div className="card-body px-0 py-0">
                  <div className="table-responsive">
                    <table
                      className="exchange-history table-responsive table shadow-hover tickettable display mb-4 dataTablesCard dataTable no-footer"
                      id="example6"
                    >
                      <thead>
                        <tr>
                          ...
                          <th className="fs-14 font-w600 border-0 ps-0">
                            Currency
                          </th>
                          ...
                          <th className="fs-14 font-w600 border-0 text-end">
                            Status
                          </th>
                        </tr>
                      </thead>
                  ...
                  <form>
                    ...
                    <div className="mb-3 mt-4">
                      ...
                      <div className="input-group mb-3">
                        ...
                        />
                        <Dropdown>
                          <Dropdown.Toggle className="btn-outline-primary left-radius">
                            Mark
                          </Dropdown.Toggle>
                          <Dropdown.Menu align="end">
                    ...
                    <div className="input-group mb-3">
                      ...
                      <Dropdown>
                        <Dropdown.Toggle
                          as="div"
                          className="btn btn-primary btn-outline-primary left-radius"
                        >
                          Mark
                        </Dropdown.Toggle>
                        <Dropdown.Menu align="end">
                    ...
                    <div className="mt-4 d-flex justify-content-between">
                      <Link
                        to={"#"}
                        className="btn btn-success py-2 text-uppercase"
                      >
                        BUY
                      </Link>
                      <Link
                        to={"#"}
                        className="btn btn-danger py-2 text-uppercase"
                      >
                        Sell
                      </Link>
                    </div>
