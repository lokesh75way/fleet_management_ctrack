...
const transactionBlog = [
  ...
  {
    image: studio2,
    title: "Akademi Studio",
    price: "$ 120,036.16",
    date: "July 5, 2022",
  },
  {
    image: studio3,
    title: "Nextrun Studio",
    price: "$ 300,036.25",
    date: "July 15, 2022",
  },
  {
...
const cardTitle = [{ title: "Income" }, { title: "Outcome" }];
                ...
                <div className="card-header justify-content-between border-0">
                  ...
                  <div className="d-flex align-items-center">
                    <Dropdown className="banking-dropdown">
                      <Dropdown.Toggle
                        as="div"
                        className="i-false banking-select"
                      >
                        {dropSelect}{" "}
                      ...
                      <Dropdown.Menu>
                        <Dropdown.Item
                          onClick={() => setDropSelect("This Mont")}
                        >
                          This Month
                        </Dropdown.Item>
                        <Dropdown.Item onClick={() => setDropSelect("Week")}>
                          Weeks
                        </Dropdown.Item>
                        <Dropdown.Item onClick={() => setDropSelect("Today")}>
                          Today
                        </Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
                ...
                <div className="card-body">
                  <div className="d-flex mb-3">
                    ...
                    <div className="ps-2 w-100 flex-1">
                      ...
                      <div className="mt-2">
                        <span>$50</span>
                        <span className="text-primary"> / from $1000</span>
                      </div>
                    </div>
                  </div>
                  <div className="d-flex mb-3">
                ...
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-inline-block position-relative donut-chart-sale">
                      <TargetDonutChart
                        value="75"
                        backgroundColor="rgba(54, 36, 101, 1)"
