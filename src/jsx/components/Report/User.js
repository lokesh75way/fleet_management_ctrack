              ...
              <div className="card">
                ...
                <div className="card-footer border-0 pt-0">
                  <div className="text-center border-0 pt-3">
                    ...
                    >
                      View More {refresh && <i className="fa fa-refresh"></i>}
                    </Link>
                  </div>
                </div>
              </div>
                ...
                <div className="card-footer border-0 pt-0">
                  <div className="text-center border-0 pt-3">
                    <Link
                      ...
                      rel="ajax/message.html"
                    >
                      View More {refresh2 && <i className="fa fa-refresh"></i>}
                    </Link>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                ...
                <div className="card-body pt-2">
                  {taskData.map((data, ind) => (
                    <div
                      className={`d-flex align-items-center ${ind === 0 || ind === 1 ? "mb-4" : ""}`}
                      key={ind}
                    >
                      <div className="icon-box icon-box-sm bg-primary">
                        <svg
                      ...
                      <div className="ms-3">
                        <h5 className="mb-1">
                          <Link className="text-secondary" to={"/activity"}>
                            {data.title}
                          </Link>
                        </h5>
                        <ul className="d-flex">
