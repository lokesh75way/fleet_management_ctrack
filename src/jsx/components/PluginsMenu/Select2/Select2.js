            ...
            <div className="card">
              <div className="card-body">
                <div className="mb-4">
                  ...
                  <p>
                    You may use the <code>data</code> configuration option to
              ...
              <div className="card-body">
                <div className="mb-4">
                  ...
                  <p>
                    ...
                    <code>closeOnSelect</code> option to prevent the dropdown
                    from closing when a result is selected:
                  </p>
                </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="mb-4">
                  ...
                  <p>
                    For multi-selects, you must <strong>not</strong> have an
                    empty
              ...
              <div className="card-body">
                <div className="mb-4">
                  ...
                  <p>
                    ...
                    <code>matcher</code> callback. If you are working with
                    nested data, you must iterate through the
                    <code>children</code> array and match them individually.
            ...
            <div className="card">
              <div className="card-body">
                <div className="mb-4">
                  ...
                  <p>
                    The <code>destroy</code> method will remove the Select2
                    widget from the target element. It will revert back to a
                    standard <code>select</code>
                    control:
                  </p>
                </div>
