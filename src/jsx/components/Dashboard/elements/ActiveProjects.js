...
const tableData = [
  {
    name: "Batman",
    name2: "Liam Risher",
    profile: IMAGES.contact1,
    progresStyle: "primary",
    progresValue: "53%",
    assigne: "3",
    status: "Inprogress",
    duedate: "01 May 2023",
  },
  {
    name: "Mivy App",
    name2: "Honey Risher",
    profile: IMAGES.contact2,
    progresStyle: "primary",
    progresValue: "50%",
    assigne: "3",
    status: "Inprogress",
    duedate: "08 June 2023",
  },
  {
    name: "Crypto App",
    name2: "Ankites Risher",
    profile: IMAGES.contact1,
    progresStyle: "danger",
    progresValue: "45%",
    assigne: "2",
                ...
                <tbody>
                  {tableData.map((item, index) => (
                    <tr key={index}>
                      <td className="sorting_1">
                        <div className="form-check custom-checkbox">
                          <input
                            ...
                            id={`projectBox${index + 1}`}
                            required=""
                          />
                          <label
                            className="form-check-label"
                            htmlFor={`projectBox${index + 1}`}
                          ></label>
                        </div>
                      </td>
                      <td>{item.name}</td>
                      ...
                      <td className="pe-0">
                        <span
                          className={`badge light border-0 badge-${item.progresStyle}`}
                        >
                          {item.status}
                        </span>
                      </td>
