...
const tableData = [
  ...
  {
    image: IMAGES.contactd12,
    name: "Men JacBlack Dress",
    price: "62.10",
    orders: "300",
    stock: "Out of Stock",
    stockColor: "danger",
          ...
          <div className="d-flex align-items-center cs-settiong">
            ...
            <Dropdown className="global-drop">
              <Dropdown.Toggle as="div" className="i-false global-drop-toggle">
                {globalSelect} <i className="fa-solid fa-chevron-down" />
              </Dropdown.Toggle>
              <Dropdown.Menu className="global-drop-menu">
                <Dropdown.Item onClick={() => setGlobalSelect("Today")}>
                  Today
                </Dropdown.Item>
                <Dropdown.Item onClick={() => setGlobalSelect("Week")}>
                  Week
                </Dropdown.Item>
                <Dropdown.Item onClick={() => setGlobalSelect("Month")}>
                  Month
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
                ...
                <tbody>
                  {tableData.map((item, index) => (
                    <tr key={index}>
                      <td className="sorting_10">
                        <div className="form-check custom-checkbox">
                          <input
                            ...
                            id={`activeproject${index + 101}`}
                            required=""
                            onClick={() => checkboxFun()}
                          />
                          <label
                            className="form-check-label"
                            htmlFor={`activeproject${index + 101}`}
                          ></label>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <span
                          className={`badge light border-0 badge-${item.stockColor}`}
                        >
                          {item.stock}
                        </span>
                      </td>
