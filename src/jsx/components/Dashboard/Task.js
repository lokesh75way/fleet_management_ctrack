...
const tableData = [
  {
    ...
    enddate: "12 june 2023",
    title: "Create Frontend WordPress",
    select: "High",
  },
  {
    emplid: "02",
  ...
  },
  {
    ...
    startdate: "06 May 2023",
    enddate: "12 june 2023",
    title: "HTML template Issue Complete",
    select: "Medium",
  },
  {
    emplid: "04",
    ...
    startdate: "06 May 2023",
    enddate: "12 june 2023",
    title: "Complete Admin Dashboard Project",
    select: "Low",
  },
  {
    emplid: "05",
        ...
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          <div className="d-flex align-items-center">
            <div className="icon-box  icon-box-sm task-tab me-2">
              <Link to={"/task-summary"}>{SVGICON.FourDots}</Link>
            </div>
            <Link
              to={"#"}
                            ...
                            <td>
                              <Dropdown className="task-dropdown-2">
                                ...
                                <Dropdown.Menu className="task-drop-menu">
                                  <Dropdown.Item
                                    onClick={() =>
                                      handleAction(item.emplid, "In Progress")
                                    }
                                  >
                                    In Progress
                                  </Dropdown.Item>
                                  <Dropdown.Item
                                    onClick={() =>
                                      handleAction(item.emplid, "Pending")
                                    }
                                  >
                                    Pending
                                  </Dropdown.Item>
                                  <Dropdown.Item
                                    onClick={() =>
                                      handleAction(item.emplid, "Testing")
                                    }
                                  >
                                    Testing
                                  </Dropdown.Item>
                                  <Dropdown.Item
                                    onClick={() =>
                                      handleAction(item.emplid, "Complete")
                                    }
                                  >
                                    Complete
                                  </Dropdown.Item>
                            ...
                            <td className="text-end">
                              <Dropdown className="task-dropdown-2">
                                ...
                                <Dropdown.Menu className="task-drop-menu">
                                  ...
                                  <Dropdown.Item
                                    onClick={() =>
                                      handleSelect(item.emplid, "Medium")
                                    }
                                  >
                                    Medium
                                  </Dropdown.Item>
