...
const postDetial = [
  {
    ...
    image2: IMAGES.contact1,
    theme: "secondary",
    maintitle: "DESIGNER",
    subtitle: "Good programmers write code that humans can understand.",
    name: "Marry",
    date: "May 05",
  },
  {
    image: IMAGES.Friends2,
    image2: IMAGES.contact2,
    theme: "primary",
    maintitle: "SOFTWARE",
    subtitle:
      "Rogramming isn't about what you know; it's about what you can figure out.",
    name: "Jarry",
    date: "April 05",
  },
  {
    image: IMAGES.Friends3,
    image2: IMAGES.contact3,
    theme: "warning",
    maintitle: "MARKTING",
    subtitle:
  ...
  },
  {
    ...
    image2: IMAGES.contact7,
    theme: "success",
    maintitle: "SOFTWARE",
    subtitle: "The best way to predict the future is to invent it.",
    name: "Harry ",
    date: "June 12",
  },
  {
...
const usersDetial = [
  ...
  {
    image1: IMAGES.Blogs3,
    image2: IMAGES.contact5,
    theme: "secondary",
    maintitle: "MARKTING",
    name: "Honey",
    date: "May 10",
...
const seoToolsData = [
  {
    image1: IMAGES.Blogs5,
    image2: IMAGES.contact1,
    theme: "secondary",
    title:
      "Debugging is like being a detective movie where you're also the murderer.",
    name: "Marry",
    date: "May 05",
  },
  {
    image1: IMAGES.Blogs6,
    image2: IMAGES.contact2,
    theme: "info",
...
const thirdPostBlog = [
  ...
  },
  {
    image1: IMAGES.Blogs2,
    image2: IMAGES.contact3,
    title: "It is a long established fact that a reader wiil",
  },
];
...
const commentsblog = [
  { image: IMAGES.contact5, title: "James Marry", subtitle: "This is Nice!!" },
  {
    ...
    subtitle: "This is Superb!!",
  },
  {
    image: IMAGES.contact1,
    title: "John Jennifer",
    subtitle: "This is Coments!!",
  },
];
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-12">
                    <div className="blog-img">
                      ...
                      <div className="blog-text">
                        <h2>
                          This quote highlights the importance of writing clear.
                        </h2>
                        <img
                          src={IMAGES.contact1}
                    ...
                    <div className="blog-post">
                      {postDetial.map((item, index) => (
                        <div className="post-1" key={index}>
                          <img
                            src={item.image}
                            className="avatar rounded-circle me-2 custome-avatar"
                            alt=""
                          />
                          <div className="post-data">
                            <span
                              className={`badge border-0 badge-sm badge-${item.theme}`}
                            >
                              {item.maintitle}
                            </span>
                            <h4>{item.subtitle}</h4>
                            <div>
                              ...
                              />{" "}
                              <span>
                                <b className="text-primary">{item.name}</b> in{" "}
                                {item.date}, 2023
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="seconday-post">
                            ...
                            <div className="post-1">
                              <div className="post-data">
                                ...
                                <h4>
                                  Debugging is like being a detective in a crime
                                  movie where you're also the murderer.
                                </h4>
                                <div>
                                  <img
                                    src={item.image2}
                        ...
                        <div className="post-1">
                          <div className="post-data">
                            ...
                            <span>
                              ...
                              and typesetting industry. Lorem Ipsum the
          ...
          <div className="col-xl-3 col-lg-5">
            ...
            <div className="recent-post">
              <div className="blog-img style-1">
                ...
                <div className="blog-text">
                  <span className="badge badge-info border-0 badge-sm mb-2">
                    DESIGNER
                  </span>
                  <h2>
                    This quote highlights the importance of writing clear.
