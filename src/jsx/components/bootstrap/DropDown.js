                    ...
                    <Card name="dropdown-header" className="dz-card">
                      <Card.Header className="flex-wrap">
                        <div>
                          ...
                          <Card.Text className="m-0 subtitle">
                            The <code>.dropdown-header</code> class is used to
                    ...
                    <Card name="dropup" className="dz-card">
                      <Card.Header className="flex-wrap">
                        <div>
                          ...
                          <Card.Text className="m-0 subtitle">
                            The <code>.dropup</code> class makes the dropdown
                            menu expand upwards instead of downwards
                          </Card.Text>
                        </div>
                        <Nav
                          as="ul"
                    ...
                    <Card name="dropstart" className="dz-card">
                      <Card.Header className="flex-wrap">
                        <div>
                          ...
                          <Card.Text className="m-0 subtitle">
                            Trigger dropdown menus at the right of the elements
                            by adding <code>.dropstart </code> to the parent
                            element
                          </Card.Text>
                        </div>
                        <Nav
                    ...
                    <Card name="custom-style" className="dz-card">
                      <Card.Header className="flex-wrap">
                        <div>
                          ...
                          <Card.Text className="m-0 subtitle">
                            Use <code>.custom-dropdown</code> this class for
                            this style
                          </Card.Text>
                        </div>
                        <Nav
                            ...
                            <Row>
                              ...
                              <Col xl={3}>
                                <Dropdown className="custom-dropdown">
                                  ...
                                  >
                                    <i className="ti-calendar me-3"></i> March
                                    20, 2018 &nbsp; To &nbsp;April 20, 2018
                                    <i className="fa fa-angle-down ms-3"></i>
                                  </Dropdown.Toggle>
                                  <Dropdown.Menu>
                                    <Dropdown.Item>
                                      May 20, 2018 &nbsp; To &nbsp; June 20,
                                      2018
                                    </Dropdown.Item>
                                    <Dropdown.Item>
