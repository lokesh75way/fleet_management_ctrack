                        ...
                        <Tab.Pane eventKey="Preview">
                          <Card.Body>
                            <Alert
                              ...
                              show={state.primary}
                            >
                              {emojis.welcome} <strong>Welcome! </strong>{" "}
                            ...
                            >
                              {emojis.done} <strong>Done! </strong> Your profile
                              photo updated.
                              <button
                                className="btn-close"
                            ...
                            <Alert
                              ...
                              show={state.success}
                            >
                              {emojis.success} <strong>Success! </strong>{" "}
                              Message has been sent.
                              <button
                                className="btn-close"
                            ...
                            <Alert variant="info" dismissible show={state.info}>
                              {emojis.info} <strong>Info! </strong> You have got
                              5 new email.
                              <button
                                className="btn-close"
                            ...
                            <Alert
                              ...
                              show={state.warning}
                            >
                              {emojis.warning} <strong>Warning! </strong>{" "}
                            ...
                            <Alert
                              ...
                              show={state.danger}
                            >
                              {emojis.error} <strong>Error! </strong> Message
                              sending failed.
                              <button
                                className="btn-close"
                            ...
                            <Alert variant="dark" dismissible show={state.dark}>
                              {emojis.error} <strong>Error! </strong> You
                            ...
                            >
                              {emojis.error} <strong>Error! </strong> You
                              successfully read this message..
                              <button
                                className="btn-close"
                        ...
                        <Tab.Pane eventKey="Preview">
                          <Card.Body>
                            ...
                            <Alert
                              ...
                              className="solid"
                            >
                              {emojis.success} <strong>Success!</strong> Message
                              has been sent.
                              <button
                                className="btn-close"
                                onClick={() =>
                                  dispatch({ type: "solidsucces" })
                                }
                              >
                                <span>
                                  <i className="fa-solid fa-xmark"></i>
                        ...
                        <Tab.Pane eventKey="Preview">
                          <Card.Body>
                            ...
                            <Alert
                              ...
                              className="solid alert-square"
                            >
                              <strong>Done! </strong> Your profile photo
                              updated.
                            </Alert>
                            <Alert
                              variant="success"
                            ...
                            <Alert
                              ...
                              className="solid alert-square"
                            >
                              <strong>Error! </strong> You successfully read
                    ...
                    <Card name="alerts-alt" className="dz-card">
                      <Card.Header className="d-flex justify-content-between flex-wrap">
                        <div>
                          ...
                          <p className="mb-0 subtitle">
                            add <code>.alert-alt</code> class to change the
                            solid color.
                          </p>
                        </div>
                        <Nav
                    ...
                    <Card name="solid-alt" className="dz-card">
                      <Card.Header className="d-flex justify-content-between flex-wrap">
                        <div>
                          ...
                          <p className="mb-0 subtitle">
                            add <code>.alert-alt.solid</code> class to change
                            the solid color.
                          </p>
                        </div>
                        <Nav
                        ...
                        <Tab.Pane eventKey="Preview">
                          <Card.Body>
                            ...
                            >
                              ...
                              <Link
                                to={"#"}
                                className="badge badge-sm light badge-primary ms-1"
                              >
                                upgrade
                              </Link>
                              <button
                            ...
                            >
                              ...
                              <Link
                                to={"#"}
                                className="badge badge-sm light badge-success ms-1"
                              >
                                upgrade
                              </Link>
                              <button
                    ...
                    <Card name="alert-icon-left" className="dz-card">
                      <Card.Header className="d-flex justify-content-between flex-wrap">
                        <div>
                          ...
                          <p className="mb-0 subtitle">
                            add <code>.alert-right-icon</code> to change the
                            style
                          </p>
                        </div>
                        <Nav
