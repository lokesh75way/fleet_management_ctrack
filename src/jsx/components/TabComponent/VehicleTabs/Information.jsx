...
const Information = ({
  ...
  return (
    <div className="p-4 relative">
      ...
      <div className="col-xl-3 mb-3">
        ...
        <div className="col-xl-3 mb-3 ">
          ...
          />
          {!getValues("tollCategory") && <Error errorName={errors.tollCategory} />}
        </div>
        <div className="col-xl-3 mb-3 ">
          <label className="form-label">
          ...
          />
          {!getValues("tarrifType") && <Error errorName={errors.tarrifType} />}
        </div>
        <div className="col-xl-3 mb-3">
          <label htmlFor="exampleFormControlInput3" className="form-label">
    ...
    >
      ...
      <div className="d-flex flex-column align-items-center border border-[#6e6e6e] p-3 mt-2">
          <div className="basic-form" style={{ marginTop: ".5rem" }}>
            <div className="form-check custom-checkbox">
              ...
              />
              <label className="form-check-label" style={{ marginBottom: "5px" }}>
              {t('reports')}
              </label>
            </div>
            <div className="form-check custom-checkbox">
