...
const roleListData = [
  ...
  {
    title: "Libabry Management",
    addchecked: false,
    editchecked: true,
    deletechecked: true,
  },
  {
    title: "Permissions for work items",
    addchecked: true,
    editchecked: false,
    deletechecked: false,
  },
          ...
          <div className="container-fluid">
            <div className="col-xl-12 mb-3">
              <label
                ...
                className="form-label font-w500"
              >
                      ...
                      <td>
                        <div className="form-check custom-checkbox checkbox-primary">
                          <input
                            ...
                            id={`addinputcheck${ind + 11}`}
                            required=""
                            defaultChecked={item.addchecked}
                          />
                          <label
                            className="form-check-label"
                            htmlFor={`addinputcheck${ind + 11}`}
                          >
                            Add
                          </label>
                        </div>
                      ...
                      <td>
                        <div className="form-check custom-checkbox checkbox-warning">
                          <input
                            type="checkbox"
                            className="form-check-input"
                            id={`editinputcheck${ind + 121}`}
                            required=""
                            defaultChecked={item.editchecked}
                          />
                          <label
                            className="form-check-label"
                            htmlFor={`editinputcheck${ind + 121}`}
                          >
                            Edit
                          </label>
                        </div>
                      ...
                      <td>
                        <div className="form-check custom-checkbox checkbox-warning">
                          <input
                            type="checkbox"
                            className="form-check-input"
                            id={`deleteinputcheck${ind + 131}`}
                            required=""
                            defaultChecked={item.deletechecked}
                          />
                          <label
                            className="form-check-label"
                            htmlFor={`deleteinputcheck${ind + 131}`}
                          >
                            Delete
                          </label>
                        </div>
