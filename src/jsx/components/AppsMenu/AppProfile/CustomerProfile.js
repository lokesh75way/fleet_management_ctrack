              ...
              <div className="card-body d-flex align-items-center justify-content-between flex-wrap">
                <div className="d-flex align-items-center c-busiess">
                  ...
                  <div>
                    ...
                    <span>
                      Billing monthly | Next payment on 15/02/2023for$590.40
                    </span>
                  </div>
                </div>
                <div>
                      ...
                      <tbody>
                        {tableData.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td>
                              <span
                                className={`badge light border-0 ${item.Status === "Pending" ? "badge-danger" : item.Status === "Completed" ? "badge-success" : "badge-primary"}`}
                              >
                                {item.Status}
                              </span>
                            </td>
              ...
              <div className="card-body pt-0">
                <div className="c-work">
                  <div className="c-task bg-primary">
                    <p>
                      Earnings<i className="fa-solid fa-arrow-down ms-2"></i>
                    </p>
                    <span>$50,585</span>
                  </div>
                  <div className="c-task bg-success">
                    <p>
                      Project <i className="fa-solid fa-arrow-up ms-2"></i>
                    </p>
                    <span>415</span>
                  </div>
                  <div className="c-task bg-secondary">
                    <p>
                      Hours <i className="fa-solid fa-arrow-up ms-2"></i>
                    </p>
                    <span>200</span>
                  </div>
                </div>
