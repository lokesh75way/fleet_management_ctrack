...
const AppCustomer = () => {
  ...
  return (
    <>
                      ...
                      <tbody>
                        {tableData.map((item, index) => (
                          <tr key={index}>
                            <td className="sorting_2">
                              <div className="form-check11custom-checkbox">
                                <input
                                  ...
                                  id={`custome${index + 151}`}
                                  required=""
                                  onClick={() => checkboxFun()}
                                />
                                <label
                                  className="form-check-label"
                                  htmlFor={`custome${index + 151}`}
                                ></label>
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <span
                                className={`badge light border-0 badge-${item.status === "Active" ? "success" : "danger"}`}
                              >
                                {item.status}
                              </span>
                            </td>
      ...
      <EmployeeOffcanvas ref={custom} Title="Add Customer" />
    </>
  );
};
