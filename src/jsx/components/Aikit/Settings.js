                  ...
                  <div className="col-xl-6 col-sm-6">
                    <div className="mb-3">
                      ...
                      <div id="emailHelp" className="form-text">
                        For instructions on how to get an OpenAI key, please
                        visit
                  ...
                  <div className="col-xl-6 col-sm-6">
                    <div className="mb-3">
                      ...
                      <div id="emailHelp-1" className="form-text">
                        Enter your RapidAPI key for Subtitles for YouTube here.
                        This API is used to read YouTube video subtitles to
                        allow you to fetch.
                        <Link to={"#"} className="text-primary">
                          Read More
                          <ToolTipBlog />
                  ...
                  <div className="col-xl-6">
                    <div className="mb-3 taginput-data">
                      ...
                      <div id="emailHelp-11" className="form-text mb-2">
                        ...
                        example, if you set this to "Shakespeare' style", the
                        mode will follow the style of Shakespeare in all text
                        generations when possible. System message should work
                        ONLY with GPT-4 and to a lesser extent with
