                ...
                <div className="row">
                  ...
                  <div className="col-xl-6">
                    <div className="mb-3">
                      ...
                      <div id="emailHelp-1" className="form-text">
                        Please set this only if you are using a fine-tuned
                        model. Leave empty if you are using any of the built-in
                        models. Completion stop sequence is used to mark the
                        stop of the completion.
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-6">
                  ...
                  <div className="col-xl-12">
                    ...
                    <div id="emailHelp-4" className="form-text">
                      ...
                      the current page to generate better responses. Important:
